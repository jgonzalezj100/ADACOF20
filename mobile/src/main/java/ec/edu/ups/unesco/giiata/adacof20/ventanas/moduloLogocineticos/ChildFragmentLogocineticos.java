 ...
 */
public class ChildFragmentLogocineticos extends Fragment implements OnClickListener {
    ...
    public static ChildFragmentLogocineticos newInstance(Bundle args) {
        ChildFragmentLogocineticos fragment = new ChildFragmentLogocineticos();
